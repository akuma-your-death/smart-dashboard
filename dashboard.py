...
while everthing_okay == False or routers_website[:4] != ip_for_proof and routers_website != last_number_ip_for_proof[-2:] or routers_website != "ip" or routers_website == "ip":
    if routers_website[:4] == ip_for_proof and routers_website[-2:] == last_number_ip_for_proof:
        with open("routers_ip.txt", "w") as file:
            file.write(routers_website)
        break
